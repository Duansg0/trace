...
import duansg.trace.core.support.MemorySupport;
...
public class TraceUtil {
     ...
     * @return
     */
    public static String getTraceIdOrInitTraceContext() {
        String traceId = TraceContextSupport.getTraceId();
        if (StringUtils.isBlank(traceId)){
            TraceInitUtil.initTraceContext();
            traceId = TraceContextSupport.getTraceId();
        }
        return traceId;
    }
}
