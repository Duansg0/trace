...
@Configuration
public class TraceDaoContainerConfiguration implements ApplicationContextAware, SmartInitializingSingleton {

    private static final Logger logger = LoggerFactory.getLogger(TraceDaoContainerConfiguration.class);
